        ...
        <div className="signUp-wrap" style={{ display: isSuccess ? 'block' : 'none' }}>
            <div className="signUp-box">
                <div className="signUpContainer">
                    ...
                    {isFailure && <div style={{ color: 'red', fontSize: '30px' }}>회원가입 실패</div>}
                    {isSuccess && <div style={{ color: 'green', fontSize: '30px' }}>회원가입 성공</div>}
                    {isValidate && <div style={{ color: 'red', fontSize: '30px' }}>중복검사가 필요합니다</div>}
                    {isPwCk && <div style={{ color: 'red', fontSize: '30px' }}>비밀번호가 일치하지 않습니다</div>}
